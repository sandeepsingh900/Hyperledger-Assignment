...
function setChaincodePath(){
	...
	case "$LANGUAGE" in
		"golang")
		CC_SRC_PATH="github.com/changed_fabric/go"
		;;
		"node")
		CC_SRC_PATH="$PWD/artifacts/src/github.com/changed_fabric/node"
		;;
...
VALUES=$(curl -s -X POST \
  ...
  \"fcn\":\"addGadget\",
  \"args\":[\"1234\",\"iphone\",\"11\",\"silver\",\"sandeep\"]
}")
echo $VALUES
...
echo
curl -s -X GET \
  "http://localhost:4000/channels/mychannel/chaincodes/mycc?peer=peer0.org1.example.com&fcn=queryAll&args=%5B%221234%22%5D" \
  -H "authorization: Bearer $ORG1_TOKEN" \
  -H "content-type: application/json"
echo
echo
